...
def create_payroll_custom_fields():
	"""Create custom fields for multi-currency payroll support"""
	custom_fields = {
		"Employee": [
			{
				"fieldname": "additional_nssf_salary",
				"fieldtype": "Currency",
				"label": "Additional NSSF Salary",
				"insert_after": "ctc",
			},
			{
				"fieldname": "nssf_children_count",
				"fieldtype": "Int",
				"label": "NSSF Children Count",
				"insert_after": "marital_status",
				"depends_on": "eval:doc.marital_status && doc.marital_status != 'Single'",
				"description": "Must be between 0 and 5",
			},
			{
				"fieldname": "nssf_wife_coverage",
				"fieldtype": "Check",
				"label": "NSSF Wife Coverage",
				"insert_after": "nssf_children_count",
				"depends_on": "eval:doc.marital_status == 'Married' && doc.gender == 'Male'",
			},
		],
		"Salary Slip": [
			{
				...
				"fetch_from": "employee.additional_nssf_salary",
				"read_only": 1,
			},
			{
				"fieldname": "nssf_children_count",
				"fieldtype": "Int",
				"label": "NSSF Children Count",
				"insert_after": "additional_nssf_salary",
				"fetch_from": "employee.nssf_children_count",
				"read_only": 1,
			},
			{
				"fieldname": "nssf_wife_coverage",
				...
				"label": "NSSF Wife Coverage",
				"insert_after": "nssf_children_count",
				"fetch_from": "employee.nssf_wife_coverage",
				"read_only": 1,
			},
			{
				"fieldname": "skipped_expenses_days",
				"fieldtype": "Float",
				"label": "Skipped Expenses Days",
				"insert_after": "leave_without_pay",
				"read_only": 1,
				"description": "Count of leave days with Skip Expenses enabled",
			},
			{
				"fieldname": "attendance_days_count",
				"fieldtype": "Float",
				"label": "Attendance Days Count",
				"insert_after": "payment_days",
				"read_only": 1,
				"description": "Number of days present based on Attendance records",
			},
			{
				"fieldname": "nssf_settings_sb",
				"fieldtype": "Section Break",
				"label": "NSSF Allowances",
				"insert_after": "attendance_days_count",
			},
			{
				"fieldname": "monthly_transportation",
				"fieldtype": "Currency",
				"label": "Monthly Transportation",
				"insert_after": "nssf_settings_sb",
				"read_only": 1,
			},
			{
				"fieldname": "wife_allowance",
				"fieldtype": "Currency",
				"label": "Wife Allowance",
				"insert_after": "monthly_transportation",
				"read_only": 1,
			},
			{
				"fieldname": "allowance_per_covered_child",
				"fieldtype": "Currency",
				"label": "Allowance per covered child",
				"insert_after": "wife_allowance",
				"read_only": 1,
			},
		],
		"Leave Type": [
			{
				"fieldname": "skip_expenses",
				"fieldtype": "Check",
				"label": "Skip Expenses",
				"insert_after": "is_lwp",
				"description": "When selected, the expenses will be deducted for these days",
			}
		],
		"Salary Component": [
			{
		...
		"Salary Detail": [
			{
				...
				"fetch_from": "salary_component.currency",
				"read_only": 1,
				"in_list_view": 1,
				"columns": 1,
			},
